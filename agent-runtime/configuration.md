...
| `RPC_URL` | **Yes** | 0G Newton testnet RPC endpoint | `https://rpc-testnet.0g.ai` | - |
...
|----------|----------|-------------|---------------|
| `USER_REGISTRY_ADDRESS` | **Yes** | UserRegistry contract address | `0x1958bdbb5926674026b9ac630c9A4Cb91718Aee7` |
| `AGENT_REGISTRY_ADDRESS` | **Yes** | AgentRegistry contract address | `0x4c49D008E72eF1E098Bcd6E75857Ed17377dB4ab` |
| `PROGRESSIVE_ESCROW_ADDRESS` | **Yes** | ProgressiveEscrow contract address | `0xe9d1d260c08385b3beB68012D425e208b4cd2295` |
| `SUBSCRIPTION_ESCROW_ADDRESS` | **Yes** | SubscriptionEscrow contract address | `0x088400FFf9d37851173e22eef904e710B88F6312` |
...
| `0G_STORAGE_RPC_URL` | **Yes** | Storage RPC endpoint | `https://rpc-testnet.0g.ai` | - |
...
0G_STORAGE_RPC_URL=https://rpc-testnet.0g.ai
...
- [ ] **RPC URL correct** - `https://rpc-testnet.0g.ai` (not deprecated URL)
- [ ] **Contract addresses valid** - Match deployed addresses on 0G Newton Testnet
- [ ] **Storage mnemonic valid** - 12 or 24 word phrase
- [ ] **Wallet has testnet tokens** - For gas fees (check on [0G Explorer](https://scan-testnet.0g.ai))
...
**Correct:**
```env
RPC_URL=https://rpc-testnet.0g.ai  ✅ CURRENT
```
...
4. Verify balance on [0G Explorer](https://scan-testnet.0g.ai)
