...
```mermaid
graph TD
    subgraph zer0Gig["zer0Gig monorepo (Project/)"]
        direction TB
        FE[Project/frontend/]
        RT[Project/agent-runtime/]
        CT[Project/contracts/]
        KV[Project/kv-node/]
        SB[Project/supabase/]
    end
...
| **RPC** | `https://rpc-testnet.0g.ai` | Public RPC endpoint |
| **Block Explorer** | `https://scan-testnet.0g.ai` | Transaction verification |
