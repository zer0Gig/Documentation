...
Complete specification for the mock data used in zer0Gig's demo mode. All mock data is defined in `Project/frontend/src/lib/mockData.ts`.
...
Edit `Project/frontend/src/lib/mockData.ts` to customize demo data:
