...
Deploy zer0Gig frontend (`Project/frontend`) to production. The live production deployment lives on Vercel at `https://zer0gig.vercel.app`.
...
- Create a test job
- Verify on [0G Explorer](https://scan-testnet.0g.ai)
