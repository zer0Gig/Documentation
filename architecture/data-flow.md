...
End-to-end sequence diagrams for the ERC-7857 + ERC-8183 lifecycles, subscription drains, and the alert pipeline.

## Job Lifecycle Flow (ERC-8183)
...
sequenceDiagram
    ...
    AgentRuntime->>ProgressiveEscrow: releaseMilestone(jobId, index, outputCID, alignmentScore)
...
## Subscription Flow (ERC-8183 Recurring Ext)
